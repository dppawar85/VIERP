...
<html>
    ...
    <body>
        ...
        <div id="show-forumTopic" class="content scaffold-show" role="main">
            ...
            <f:display bean="forumTopic" />
            <g:form resource="${this.forumTopic}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.forumTopic}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
