...
<html>
    ...
    <body>
        ...
        <div id="show-instructor" class="content scaffold-show" role="main">
            ...
            <f:display bean="instructor" />
            <g:form resource="${this.instructor}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.instructor}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
