...
<tr><td><lable><span class="error">*</span>&nbsp;Week Number:</lable></td><td><center> <g:select class="form-control"  name="week_number" from="${week_number_list}"/></td></tr>
<tr><td><label><span class="error">*</span>&nbsp;Start Date:</label></td><td><center> <g:datePicker name="start_date"  precision="day" value="${new Date()}" /></td></tr>
<tr><td><label><span class="error">*</span>&nbsp;End Date:</label></td><td><center> <g:datePicker name="end_date"  precision="day" value="${new Date()}" /></td></tr>
                        ...
                        <g:each in="${week_list}" status="i" var="d">
                            <tr class="${(i % 2) == 0 ? 'success' : 'warning'}" >
                                ...
                                <td><center>  <g:formatDate date="${d.end_date}" name="end_date" format="dd-MM-yyyy"/></center></td>
                                 ...
                                 <td><center>  <g:link action="deleteweek" id="${d.id}" params="[coffrid: coff.id]"><i class="fa fa-2x fa-trash" aria-hidden="true" data-toggle="tooltip" title="Delete"></i></g:link></center> </td>
                            </tr>
                        </g:each>
                    </tbody>
                </table>
