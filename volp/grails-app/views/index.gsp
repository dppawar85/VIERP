                     ...
                     <nav class="navigation" >
                          <g:each var="obj" in="${menus}">
                          	<ul class="mainmenu navigation" >
                          		...
                          		<li ><g:link  action="y" controller="courseCategory" params="[ccid: obj[0].id]">
...
function nextcat1(){
  ...
  xmlhttp.open("GET", "/login/catSlider1?crsids=" + crsids+"&cc="+${catname1}, true);
  xmlhttp.send();
}
function prevcat1(){
  var crsids =[]
...
function nextcat2(){
  ...
  xmlhttp.open("GET", "/login/catSlider2?crsids=" + crsids+"&cc="+${catname2}, true);
  xmlhttp.send();
}
function prevcat2(){
...
function nextcat3(){
  ...
  xmlhttp.open("GET", "/login/catSlider3?crsids=" + crsids+"&cc="+${catname3}, true);
  xmlhttp.send();
}
function prevcat3(){
...
function nextcat4(){
  ...
  xmlhttp.open("GET", "/login/catSlider4?crsids=" + crsids+"&cc="+${catname4}, true);
  xmlhttp.send();
}
function prevcat4(){
...
function next(){
  ...
  xmlhttp.open("GET", "/login/crsSlider?crsids=" + crsids, true);
  xmlhttp.send();
}
function prev(){
