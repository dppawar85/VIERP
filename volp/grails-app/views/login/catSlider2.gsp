...
<a href="#" class="previous" id="prev_button" onclick="prevcat2()"><i class="fa fa-chevron-left fa-2x" aria-hidden="true"></i>PREV</a>
</div>
<div style="float:right">
<a href="#" onclick="nextcat2()">NEXT<i class="fa fa-chevron-right fa-2x" aria-hidden="true"></i></a>
</div>
</div> -->
 ...
 <div class="card" style="display:block;height:300px" >
        ...
        <g:if test="${(cnt==0)}">
                                                  <div style="position:absolute;left:-20px;opacity:.5">
                                                   <a href="#sld3" onclick="prevcat2()"><i class="fa fa-chevron-circle-left fa-3x" aria-hidden="true"></i></a>
                                                  </div>
                                                  </g:if>
                     <g:if test="${cnt==3}">
                                                               <div style="position:absolute;right:-20px;opacity:.5">
                                                                <a href="#sld3" onclick="nextcat2()"><i class="fa fa-chevron-circle-right fa-3x" aria-hidden="true"></i></a>
                                                               </div>
                                                               </g:if>
