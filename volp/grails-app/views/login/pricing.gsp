     ...
     <div class="row slideanim slide">
       <div class="col-sm-4 col-xs-12">
         <div class="panel panel-default text-center">
           <div class="panel-heading" style="background-color: #f4511e;color: white;">
             <h2>Basic</h2>
           </div>
           ...
           <div class="panel-footer">
             <h3>$19</h3>
             <h4>per month</h4>
             <a class="btn btn-lg" href="${request.contextPath}/login/login"">Sign Up</a>
           </div>
         </div>
       </div>
       <div class="col-sm-4 col-xs-12">
         <div class="panel panel-default text-center">
           <div class="panel-heading " style="background-color: #8BC34A;color: white;">
             <h2>Pro</h2>
           </div>
           <div class="panel-body">
            </div>
           <div class="panel-footer">
             <h3>$29</h3>
             <h4>per month</h4>
             <a class="btn btn-lg" href="${request.contextPath}/login/login"" style="background-color: #8BC34A;color: white;">Sign Up</a>
           </div>
         </div>
       </div>
       <div class="col-sm-4 col-xs-12">
         <div class="panel panel-default text-center">
           ...
           <div class="panel-footer">
             <h3>$49</h3>
             <h4>per month</h4>
             <a class="btn btn-lg" href="${request.contextPath}/login/login"" style="background-color: #FFC107;color: white;">Sign Up</a>
           </div>
         </div>
       </div>
     </div>
