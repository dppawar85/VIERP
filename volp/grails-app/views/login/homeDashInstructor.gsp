  ...
  <header>
    <nav class="line navbar header1" >
      ...
      <div class="left1 col-md-3">
             ...
             <ul >
               <li> <a href="${request.contextPath}/instructor/instructor"> <i class="fa fa-bars"></i>&nbsp;&nbsp;Dashboard </a></li>
               <li> <i class="fa fa-user"></i>&nbsp;&nbsp;Hello ${session.firstName} </li>
               <li> <a href="${request.contextPath}/login/logout"><i class="fa fa-sign-out"></i>&nbsp;Sign Out</a> </li>
