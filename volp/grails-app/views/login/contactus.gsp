...
<div class="w3-container w3-padding-64 " id="contact">
  <div class="w3-row">
    <div class="w3-col m5">
    <div class="w3-padding-16"><span class="w3-xlarge w3-border-orange w3-bottombar">Contact Us</span></div>
      <h3>Address</h3>
      <p><i class="fa fa-institution w3-text-orange w3-xlarge"></i> &nbsp;Vishwakarma Institute of Technology</p>
      <p><i class="fa fa-map-marker w3-text-orange w3-xlarge"></i>&nbsp;&nbsp;666, Upper Indiranagar, Bibwewadi</p>
      <p><i class="fa fa-map-marker w3-text-orange w3-xlarge"></i>&nbsp;&nbsp;Pune, Maharashtra, INDIA - 411 037.</p>
      <p><i class="fa fa-phone w3-text-orange w3-xlarge"></i>&nbsp;&nbsp;+91 077 09 601881</p>
      <p><i class="fa fa-envelope-o w3-text-orange w3-xlarge"></i>&nbsp;&nbsp;volp.vu@gmail.com</p>
    </div>
    <div class="w3-col m7" >
      <g:form class="w3-container w3-card-2 w3-padding-16" action="saveContactDetails" method="POST">
      ...
      <div class="w3-section">
       ...
       <g:submitToRemote class="w3-button w3-teal w3-right"  url="[controller : 'enquiry',action: 'saveContactDetails']" update="updateMe" value="Send" />
