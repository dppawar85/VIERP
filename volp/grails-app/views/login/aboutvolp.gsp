...
<div class="container">
 <h3 style="margin-left: 5px"> About VOLP</h3>
<div class="jumbotron" >
 <p style="text-align: justify">We believe in the highest quality education, both online and in the classroom.
 <br>VOLP has been created for learners and institutions that seek to transform themselves through cutting-edge technologies, innovative pedagogy and rigorous courses.
 <br>Through our institution, we present the best of higher education online, offering opportunities to anyone who wants to thrive, grow and achieve.
 <br>Our goals, however, go beyond offering courses. We are committed to research that will allow us to understand how learners get trained, how technology can transform learning, and the ways faculty and professors employ to teach on campus and beyond.
 <br>As innovators and experimenters, we want to share what we discover. By conducting and publishing significant research on how learners get trained, we will empower and inspire educators around the world and promote success in Indian massive open online learning.
 <br>Our aim is to become a leading resource for learners by staying focused on the goals and principles set forth, when forming VOLP
</p>
<hr>
<h3>Our Goals</h3>
<ul>
      <i class="fa fa fa-caret-right"></i> &nbsp;Expand access to education for learners spread across remote areas<br>
      <i class="fa fa fa-caret-right"></i> &nbsp;Enhance teaching and learning on campus and online<br>
      <i class="fa fa fa-caret-right"></i> &nbsp;Advance teaching and learning through research work<br>
       <i class="fa fa fa-caret-right"></i> &nbsp;Spread quality education wherever there is internet access<br>
 </ul>
</div>
</div>
