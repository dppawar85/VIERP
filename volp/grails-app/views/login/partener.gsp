...
<div class="container-fluid bg-3 text-center">
  ...
  <div class="row">
    <div class="col-sm-4">
      <p style="background: #2eacf5;">Vishwakarma Institute Of Technology</p>
     <asset:image src="homeImages/vit_logo.png" alt="homeImages1"  />
    </div>
    <div class="col-sm-4">
      <p style="background: #ff5820;">Vishwakarma University</p>
      <asset:image src="homeImages/VU.png" alt="homeImages1" />
    </div>
    <div class="col-sm-4">
      <p style="background: #2eacf5;">Vishwakarma Institute Of Information Technology</p>
      <asset:image src="homeImages/vit_logo.png" alt="homeImages1" />
    </div>
  </div>
</div>
