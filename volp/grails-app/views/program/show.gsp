...
<html>
    ...
    <body>
        ...
        <div id="show-program" class="content scaffold-show" role="main">
            ...
            <f:display bean="program" />
            <g:form resource="${this.program}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.program}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
