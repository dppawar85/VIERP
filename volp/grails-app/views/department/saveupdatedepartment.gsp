              ...
              <g:form action="savedepartment">
               ...
               <tbody>
                <tr>
                    ...
                    <td><input class="form-control"  name="name" type="name" required></td>
                </tr>
                <tr>
                    <td colspan="2" align="center"> <g:submitToRemote class="btn btn-primary" url="[controller:'Department', action:'saveupdatedepartment']" update="mainorgranizationajax" value="Add Department"/></td>
                </tr>
               </tbody>
               </table>
               </g:form>
