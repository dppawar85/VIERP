...
<div class="container" style="position : relative;font-size: 15px; margin-left: 20%">
    <g:form controller="CourseCategory" action="savesubcategory" >
                    <lable>Category:</lable>
                    <input class="form-control"  name="maincategory" type="name" value="${maincategory}" required="true" readonly>
                    <lable>Sub-Category:</lable>
                    <input class="form-control"  name="subcategory" type="name" placeholder="Enter Sub Category" required="true" >
                    <g:submitToRemote class="btn btn-primary" url="[controller:'CourseCategory', action:'savesubcategory']" update="mainorgranizationajax" value="Add Sub-Category" />
    </g:form>
    <br><br>
