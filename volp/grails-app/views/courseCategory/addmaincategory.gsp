...
<a class="btn btn-sm btn-warning" onclick="changesubcategorylinking()">
 ...
 <br><br>
    <g:form controller="CourseCategory" action="savemaincategory" >
    <div class="input-group">
     <lable>Category:</lable> <input class="form-control" name="maincategory" type="name" placeholder="Enter Main Category" required="true">
      <span> <g:submitToRemote class="btn btn-primary input-group-addon" url="[controller:'CourseCategory', action:'savemaincategory']" update="mainorgranizationajax" value="Add Main Category" /></span>
