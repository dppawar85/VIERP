...
<html>
    ...
    <body>
        ...
        <div id="show-enquiry" class="content scaffold-show" role="main">
            ...
            <f:display bean="enquiry" />
            <g:form resource="${this.enquiry}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.enquiry}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
