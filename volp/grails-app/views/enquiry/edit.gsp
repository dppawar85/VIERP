...
<html>
    ...
    <body>
        ...
        <div id="edit-enquiry" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.enquiry}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.enquiry}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.enquiry}" method="PUT">
                <g:hiddenField name="version" value="${this.enquiry?.version}" />
                <fieldset class="form">
                    <f:all bean="enquiry"/>
                </fieldset>
