...
<html>
    ...
    <body>
        ...
        <div id="show-courseOffering" class="content scaffold-show" role="main">
            ...
            <f:display bean="courseOffering" />
            <g:form resource="${this.courseOffering}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.courseOffering}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
